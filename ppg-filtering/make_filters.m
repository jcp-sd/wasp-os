...
[b_hp, a_hp] = cheby2(5, Rs, 0.54*f_1, 'high');		% tau_s = 48 ms

clf;
fvtool(b_hp, a_hp, 'MagScale','Logarithmic'); hold on;
plot((30.0/60.0)/fn, -6, 'ro');
plot(f_1, 0, 'ko');
set(gca, 'FontSize', 14)
...
Rs = 30.0;
%[b_lp, a_lp] = cheby2(3, Rs, 1.800*f_2);	% tau_s = 24 ms
[b_lp, a_lp] = cheby2(3, Rs, 1.525*f_2);	% tau_s = 48 ms
...
printf('b_lp = %.14g %.14g %.14g %.14g\n', b_lp);
printf('a_lp = %.14g %.14g %.14g %.14g\n', a_lp);
